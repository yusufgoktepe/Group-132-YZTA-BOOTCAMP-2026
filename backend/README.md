...
verisi eklenmiştir. Açılışta 56 geriye uyumlu etkinliğe ek olarak 1.000 sentetik
profil, 80 resmî ve 170 mikro etkinlik, 1.200 katılım, 800 rating ve 5.393 başlangıç
ilgi ağırlığı idempotent biçimde seed edilir. Birleşik demo kataloğu toplam 306
etkinlik içerir.
...
Mobilde kullanılan ÖSYM 2026 üniversite/program kimlikleri, V3 sentetik hedefleme
kimlikleriyle uyumluluk eşlemesi üzerinden değerlendirilir. Böylece resmî referans
seçimleri V3 aday filtrelerini devre dışı bırakmaz.
